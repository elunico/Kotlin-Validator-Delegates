...
infix fun StringRules.CharClass.or(other: StringRules.CharClass): StringRules.CharClass {
    return StringRules.CharClass.satisfying { this(it) || other(it) }
}
...
object Validators {
    ...
    class String<R>(
        ...
        val acceptableLength: StringRules.AcceptableLength = StringRules.AcceptableLength.unbound(),
        ...
        companion object {
            ...
            fun <R> alphanumeric(initValue: kotlin.String): String<R> = String<R>(
                initValue,
                StringRules.AcceptableLength.unbound(),
                StringRules.MustHave { Only { StringRules.CharClass.alphanumeric } }
            )
            ...
            fun <R> alphanumericAndWhitespace(initValue: kotlin.String, locale: Locale): String<R> = String(
                initValue,
                StringRules.AcceptableLength.unbound(),
                StringRules.MustHave { Only { StringRules.CharClass.alphanumeric or StringRules.CharClass.whitespace } }
            )
            ...
            fun <R> noWhitespace(initValue: kotlin.String): String<R> = String(
                initValue,
                StringRules.AcceptableLength.unbound(),
                StringRules.MustHave { No { StringRules.CharClass.whitespace } }
            )
        }
    }
